...
export const protobufPackage = "jemrickrioux.loan.loan";
...
export class MsgClientImpl {
    ...
    LiquidateLoan(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.loan.Msg", "LiquidateLoan", data);
        return promise.then((data) => MsgLiquidateLoanResponse.decode(new Reader(data)));
    }
    CancelLoan(request) {
        const data = MsgCancelLoan.encode(request).finish();
        const promise = this.rpc.request("jemrickrioux.loan.loan.Msg", "CancelLoan", data);
