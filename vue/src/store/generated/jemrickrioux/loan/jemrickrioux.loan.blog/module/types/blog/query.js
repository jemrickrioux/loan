...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Post(request) {
        const data = QueryGetPostRequest.encode(request).finish();
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "PostAll", data);
    ...
    SentPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "SentPost", data);
    ...
    SentPostAll(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "SentPostAll", data);
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "TimedoutPost", data);
    ...
    TimedoutPostAll(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Query", "TimedoutPostAll", data);
