...
export const protobufPackage = "jemrickrioux.loan.blog";
...
export class MsgClientImpl {
    ...
    CreateSentPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "CreateSentPost", data);
    ...
    UpdateSentPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "UpdateSentPost", data);
    ...
    DeleteSentPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "DeleteSentPost", data);
    ...
    CreateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "CreateTimedoutPost", data);
    ...
    UpdateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "UpdateTimedoutPost", data);
    ...
    DeleteTimedoutPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "DeleteTimedoutPost", data);
    ...
    SendIbcPost(request) {
        ...
        const promise = this.rpc.request("jemrickrioux.loan.blog.Msg", "SendIbcPost", data);
